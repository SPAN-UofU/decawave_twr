...
int main(void)
{
    ...
    dwt_setrxaftertxdelay(POLL_TX_TO_RESP_RX_DLY_UUS); /* Delay in turning on receiver after a frame transmission is completed 5.52 api */
    dwt_setrxtimeout(RESP_RX_TIMEOUT_UUS); /* Sets the receiver to timeout and disable when no frame is received with the specified time. 5.30 api */
    dwt_setpreambledetecttimeout(PRE_TIMEOUT); /* Sets the receiver to timeout and disable when no preamble is received within this time 5.31 api */
